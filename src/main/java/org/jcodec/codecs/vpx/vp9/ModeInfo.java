...
public class ModeInfo {
    ...
    public static int readKfIntraMode(int miCol, int miRow, int blSz, VPXBooleanDecoder decoder,
            DecodingContext c) {
    ...
    public static int readKfIntraModeSub(int miCol, int miRow, int blSz, VPXBooleanDecoder decoder,
            DecodingContext c) {
        boolean availAbove = miRow > 0; // Frame based
        boolean availLeft = miCol > c.getMiTileStartCol(); // Tile based
        int[] aboveIntraModes = c.getAboveModes();
